...
function f_Status()
{
    ...
    sudo -u root systemctl --no-pager status isc-dhcp-server;
}
...
function f_Start()
{
    ...
    sudo -u root systemctl start isc-dhcp-server;
}
...
function f_Stop()
{
    ...
    sudo -u root systemctl stop isc-dhcp-server;
}
...
function f_Enable()
{
    ...
    sudo -u root systemctl enable isc-dhcp-server;
}
...
function f_Disable()
{
    ...
    sudo -u root systemctl disable isc-dhcp-server;
}
